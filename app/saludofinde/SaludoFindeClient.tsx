...
export default function SaludoFindeClient() {
  ...
  function reproducir() {
    ...
    // El <video> recién se monta al setear reproduciendo=true, así que el
    // .play() tiene que esperar al siguiente tick para encontrar el nodo.
  ...
  return (
    <main style={{
      ...
      <h1 style={{ fontSize: '1.6rem', margin: 0 }}>Un saludo de finde 🤠</h1>
        ...
        {reproduciendo ? (
          ...
          <button
            ...
            style={{
              ...
              background: `url('/saludofinde/poster.png') center/cover`,
              position: 'relative',
            }}
